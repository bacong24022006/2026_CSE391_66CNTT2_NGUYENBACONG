...
>   Điều này cho em biết rằng:

File main.js đã được liên kết đúng với HTML.

JavaScript được thực thi ngay khi trang web được tải.

Lệnh console.log() đã chạy và in thông báo ra Console.

👉 Điều đó chứng tỏ JavaScript đang hoạt động bình thường
...
>
> - HTML: Tạo cấu trúc nội dung cho trang web (khung xương)
> - CSS: Định dạng và trang trí giao diện (màu sắc, bố cục)
> - JavaScript: Xử lý logic và tạo tương tác cho trang web
...
>   - `number` là: kiểu dữ liệu dùng để lưu trữ số (ví dụ: 10, 3.14, -5)
>   - `string` là:kiểu dữ liệu dùng để lưu trữ chuỗi ký tự (ví dụ: "Hello", "An", "123")
>   - `boolean` là: là: kiểu dữ liệu chỉ có hai giá trị là true hoặc false
